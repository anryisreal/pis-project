...
export const ImportButton: React.FC = () => {
    ...
    const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            if (!FileService.isValidYamlFile(file)) {
                throw new Error('Пожалуйста, выберите YAML файл (.yml или .yaml)');
            }
            ...
            const content = await FileService.loadYamlFile(file);
            ...
            // Парсинг YAML
            console.log('5. Parsing YAML...');
            const grammar = YamlService.parseYaml(content);
            console.log('6. YAML parsed successfully:', {
            ...
            alert(`✅ Грамматика успешно загружена!\n\nПаттернов: ${patternCount}`);
        ...
        <div className="relative">
            ...
            >
                ...
                <span className="text-sm">
                    {isLoading ? 'Загрузка...' : 'Импорт YAML'}
                </span>
            </button>
